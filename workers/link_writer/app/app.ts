...
// APP settings
const CLIENT_ID: string = ( env.HOSTNAME ? env.HOSTNAME : 'link_writer_undefined_host' );
...
( async (): Promise<void> => {
  ...
  new LinkWriter( CLIENT_ID, SERVICE_ID, redis_sub_client, redis_pub_client, logger, dbconn);
})();